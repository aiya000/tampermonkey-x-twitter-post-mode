...
2. Open [`x-post-mode.user.js`](./x-post-mode.user.js) and click **Raw**.
...
| Action | Result |
|---|---|
| Visit `x.com/home` with Post Mode ON | Compose area only |
| Visit `x.com/{username}` with Post Mode ON | Profile info + Post button |
